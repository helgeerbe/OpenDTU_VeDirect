    ...
    while (offset < endOfGroup) {
        ...
        if (art == 4) {
            ...
            if (count == 8) {
                ...
                dataInFlight.add<DataPointLabel::PowerTotal>(powerTotal);
                dataInFlight.add<DataPointLabel::PowerL1>(powerL1);
                dataInFlight.add<DataPointLabel::PowerL2>(powerL2);
                dataInFlight.add<DataPointLabel::PowerL3>(powerL3);
